...
app.get('/api/admin/users',requireRole('admin'),(req,res)=>res.json(db.prepare('SELECT id,username,email,role,display_name,active,created_at,updated_at FROM users ORDER BY username').all()));
